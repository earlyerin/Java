...
public class Day03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("result5="+ n1 +",result6=" + n2);
		...
		int result5 = 1000000*1000000; //결과값이 int형의 데이터 범위를 벗어남
		System.out.println(result5); //오버플로우로 인한 에러 발생
		
		long result6 = 1000000*1000000L;
		...
		//Quiz. 두 수를 입력받아 사칙연산을 수행하는 프로그램
